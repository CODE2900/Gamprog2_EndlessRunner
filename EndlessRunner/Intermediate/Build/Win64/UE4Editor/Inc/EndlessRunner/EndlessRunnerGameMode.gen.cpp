...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEndlessRunnerGameMode_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AEndlessRunnerGameMode_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_AEndlessRunnerGameMode()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_AEndlessRunnerGameMode_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(AEndlessRunnerGameMode, 3343344206);
	template<> ENDLESSRUNNER_API UClass* StaticClass<AEndlessRunnerGameMode>()
	{
		return AEndlessRunnerGameMode::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AEndlessRunnerGameMode(Z_Construct_UClass_AEndlessRunnerGameMode, &AEndlessRunnerGameMode::StaticClass, TEXT("/Script/EndlessRunner"), TEXT("AEndlessRunnerGameMode"), false, nullptr, nullptr, nullptr);
